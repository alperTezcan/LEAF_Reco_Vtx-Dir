void ProducePDF(){
  ...
  TH1D * ChargeProfile[nFiles][nPMTtypes];
  TCanvas * cChargeProfile;
  TH1D * ratioChargeProfile[nFiles][nPMTtypes];
  TH1D * ChargePerPMT[nFiles][nPMTtypes];
  TCanvas *cChargePerPMT;
  TH1D * TotalCharge[nFiles][nPMTtypes];
  TCanvas *cTotalCharge; 
  TH1D * TotalHit[nFiles][nPMTtypes];
  TCanvas *cTotalHit;
